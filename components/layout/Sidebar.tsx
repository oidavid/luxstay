    ...
    <>
      ...
      <style>{`
        ...
        .lux-sidebar-logo-icon {
          width: 32px; height: 32px; background: var(--gold-500);
          border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;
        }
        .lux-sidebar-brand {
          font-family: 'Playfair Display', serif; font-size: 18px;
          font-weight: 700; color: white; display: block; line-height: 1;
        }
        .lux-sidebar-tagline { font-size: 11px; color: var(--slate-400); margin-top: 2px; }
        .lux-sidebar-nav {
        ...
        .lux-sidebar-group-label {
          ...
          text-transform: uppercase; color: var(--navy-500); padding: 0 12px; margin-bottom: 4px;
        }
        .lux-nav-item {
          display: flex; align-items: center; gap: 10px;
          padding: 8px 12px; border-radius: 8px;
          font-size: 13.5px; font-weight: 500;
          color: var(--sidebar-text); text-decoration: none; transition: all 0.12s;
        }
        ...
        .lux-sidebar-bottom { padding: 12px; border-top: 1px solid var(--navy-700); }
        .lux-sidebar-user {
          display: flex; align-items: center; gap: 10px;
        ...
        .lux-sidebar-user-role { font-size: 11px; color: var(--slate-400); }
        .lux-signout-btn {
        ...
        .lux-bottom-nav {
          ...
          z-index: 50; background: var(--navy-900);
          border-top: 1px solid var(--navy-700);
          padding-bottom: env(safe-area-inset-bottom);
        }
        @media (max-width: 768px) { .lux-bottom-nav { display: flex; align-items: center; justify-content: space-around; } }
        .lux-bottom-nav-item {
